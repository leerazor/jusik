...
target serialization 오차는 1e-38 이하, 실제 deviation은 1e-41 이하였고 Python hash-order 차이로 설명된다. 모든 trade/equity/metric은 archive와 정확히 일치했으며 fixture observer off/on도 정확히 일치했다. 결과는 과거 재사용 자료이며 배당·세금은 제외했고, prospective/live/PAPER 변경이나 승격을 수행하지 않았다.
