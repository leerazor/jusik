...
| 1b | 새 roadmap 코드 산출물의 별도 완료 reviewer 연결 | `lab-roadmap-completion-review` 구현 중. 명시적인 v2 소유 계약만 기존 host review 경로 재사용; legacy 승인·보고 전용/금융 연구의 완료 계약은 자동 변경하지 않음 |
