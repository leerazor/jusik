...
자동 연구는 함께 추적하는 `research-mandate.json`의 최신 사용자 의사를 따릅니다. 현재 JSON SHA-256은 `425875a0b193a84c78f13ab73d7b017947f2446caa8c1adb04177c54f0750d01`입니다. 과거 실험이 고정한 원본과 계약은 해당 실험의 근거로 보존하며, 새 조건을 적용했다고 과거 결과를 다시 해석하지 않습니다.
