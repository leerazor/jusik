...
자동 연구는 함께 추적하는 `research-mandate.json`의 최신 사용자 의사를 따릅니다. 현재 JSON SHA-256은 `2f7b98341b80a3dd290a28b888af65d60bef26564d4e8dd265383fa5a84279f4`입니다. 과거 실험이 고정한 원본과 계약은 해당 실험의 근거로 보존하며, 새 조건을 적용했다고 과거 결과를 다시 해석하지 않습니다.
