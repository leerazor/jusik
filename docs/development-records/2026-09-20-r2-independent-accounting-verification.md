...
- 검증: `PYTHONPATH=backend backend/.venv/bin/python -m pytest -q
  backend/tests/test_research_portfolio_accounting_evidence.py
  backend/tests/test_market_history_action_accounting.py
  backend/tests/test_research_mandate_governance.py` — 58 passed (2026-09-20 재검증).
