...
export default async function ResearchHistoryPage({ searchParams }: PageProps) {
  ...
  return (
    <main>
      <header className="research-result-header"><Link href="/research" className="brand"><span className="mark">J</span> jusik <span className="brand-sub">연구 이력</span></Link><div className="action-row"><Link className="secondary-button" href="/research/progress">연구 진행 현황</Link><Link className="secondary-button" href="/research/forward">전진 관찰</Link></div></header>
